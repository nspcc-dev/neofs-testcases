...
def pub_key_in_alphabet_pub_keys_from_mainchain(neofs_env: NeoFSEnv, neo_go: NeoGo, expected_key: str) -> list[str]:
...
def test_replace_ir_node_from_main_chain(clear_neofs_env: NeoFSEnv):
    ...
    with allure.step("Replace existing inner ring node with a new one"):
        ...
        pub_key_in_alphabet_pub_keys_from_mainchain(neofs_env, neo_go, new_inner_ring_pub_key)
