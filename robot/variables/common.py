...
NEOFS_EPOCH_TIMEOUT = (os.getenv("NEOFS_EPOCH_TIMEOUT") if "NEOFS_EPOCH_TIMEOUT" in os.environ else os.getenv("NEOFS_IR_TIMERS_EPOCH", "300s"))
...
NEO_MAINNET_ENDPOINT = (os.getenv("NEO_MAINNET_ENDPOINT") if "NEO_MAINNET_ENDPOINT" in os.environ else os.getenv("NEOFS_IR_MAINNET_ENDPOINT_CLIENT", 'http://main_chain.neofs.devenv:30333'))
...
NEOFS_NEO_API_ENDPOINT = (os.getenv("NEOFS_NEO_API_ENDPOINT") if "NEOFS_NEO_API_ENDPOINT" in os.environ else os.getenv("NEOFS_IR_MORPH_ENDPOINT_CLIENT", 'http://morph_chain.neofs.devenv:30333'))
...
NEOFS_CONTRACT = (os.getenv("NEOFS_CONTRACT") if "NEOFS_CONTRACT" in os.environ else os.getenv("NEOFS_IR_CONTRACTS_NEOFS", '1e6d8b8e1a7c976649dc630062d8b281cb9c2615'))
DEF_WALLET_ADDR = "NVUzCUvrbuWadAm6xBoyZ2U7nCmS9QBZtb"
