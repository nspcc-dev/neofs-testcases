...
class NeoGoNep11(CliCommand):
    def parse_nep11_balance(self, balance_output: str) -> dict[str, str | list[str]]:
        ...
        Returns:
            dict with 'account_address', 'container_id', and 'token_ids' (list of all tokens) keys
        """
        ...
        for line in lines:
            ...
            if line.startswith("Account "):
                ...
                # Extract container ID from format: FSCNTR: NeoFS Container (14c9fcc666362438fb008faf4fb4309f90b4e92f)
                if "(" in line and ")" in line:
                    container_id = line.split("(")[1].split(")")[0].strip()
