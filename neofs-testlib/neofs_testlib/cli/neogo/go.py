...
from neofs_testlib.cli.neogo.nep11 import NeoGoNep11
...
class NeoGo:
    ...
    nep11: Optional[NeoGoNep11] = None
    ...
    def __init__(
        ...
        self.nep11 = NeoGoNep11(shell, neo_go_exec_path, config_path=config_path)
